...
const ERAS = [
  ...
  { id:"abstraction", num:"18", title:"절대주의와 추상표현주의", en:"Suprematism & Abstract Expressionism", period:"20세기",
    ...
    keys:["말레비치·절대주의","몬드리안·신조형주의","폴록·액션페인팅","마크 로스코","에셔 테셀레이션"],
    imgs:[
      { t:"검은 사각형 (Black Square)", a:"카지미르 말레비치", y:"1915", src:"/images/검은사각형.jpg" },
      { t:"빨강, 파랑, 노랑의 구성", a:"피에트 몬드리안", y:"1930", src:"/images/빨강파랑노랑의구성.webp" },
