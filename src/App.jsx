...
const ERAS = [
  ...
  { id:"impressionism", num:"07", title:"인상주의", en:"Impressionism", period:"19세기",
    ...
    imgs:[
      ...
      { t:"이삭 줍는 사람들", a:"장 프랑수아 밀레", y:"1857" },
      { t:"인상, 해돋이", a:"클로드 모네", y:"1872" },
      { t:"올랭피아", a:"에두아르 마네", y:"1863" },
    ],
  ...
  { id:"art-therapy", num:"10", title:"미술치료", en:"Art Therapy", period:"수업 후반",
    ...
    imgs:[
      { t:"팀 발표 슬라이드 (직접 제작)", a:"우리 팀", y:"2025" },
      { t:"S-HTP 분석 자료", a:"수업 발표", y:"2025" },
      { t:"수업 필기 손글씨", a:"본인", y:"2025" },
    ],
  ...
  { id:"abstraction", num:"18", title:"절대주의와 추상표현주의", en:"Suprematism & Abstract Expressionism", period:"20세기",
    ...
    imgs:[
      { t:"낮과 밤 (Day and Night)", a:"M.C. 에셔", y:"1938" },
      { t:"그리는 손 (Drawing Hands)", a:"M.C. 에셔", y:"1948" },
      { t:"Number 5", a:"잭슨 폴록", y:"1948" },
    ],
