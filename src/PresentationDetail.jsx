...
const PRESENTATIONS = {
  ...
  "minhwa-ukiyoe": {
    ...
    count:90,
    body:"솔직히 가장 힘들었던 발표였다. 민화는 작자 미상에 바리에이션도 다양하고 현대까지 이어지는 살아있는 사조라 자료 찾기가 쉽지 않았다. 그럼에도 도상 안에 담긴 의미를 공부하면서, 선조들이 그림에 어떤 소망을 담았는지를 생각해볼 수 있었다. 교수님의 작품 또한 조사할 수 있어 감사한 기회였다고 생각한다.",
  },
};
