  ...
  return (
    <div style={{minHeight:"100vh",background:"#f0eff5",display:"flex",flexDirection:"column"}}>
      <nav style={{
        ...
        <p style={{fontFamily:"'Cormorant Garamond',serif",fontSize:13,fontStyle:"italic",color:"rgba(0,0,0,.2)"}}>
          Presentations
        </p>
      </nav>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"100px 44px"}}>
        ...
        <div style={{
          ...
          <p style={{fontFamily:"'Noto Sans KR',sans-serif",fontSize:11,fontWeight:300,color:"#ccc",letterSpacing:".06em"}}>
            발표 자료를 추가할 예정
          </p>
        </div>
      </div>
